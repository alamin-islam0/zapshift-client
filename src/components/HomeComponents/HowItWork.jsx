            ...
            <div className="container mx-auto ">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {steps.map((step, index) => (
                        <div key={index} className="bg-white p-8 rounded-3xl hover:shadow-lg transition-shadow duration-300">
                            ...
                            <h3 className="text-xl font-bold text-[#03373d] mb-3">{step.title}</h3>
